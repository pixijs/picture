...
const background = PIXI.Sprite.fromImage('required/assets/BGrotate.jpg');
...
const dudeArray : Array<any> = [];

const totaldudes = 20;
const texture = PIXI.Texture.fromImage('required/assets/flowerTop.png');

for (let i = 0; i < totaldudes; i++)
{
	// create a new Sprite that uses the image name that we just generated as its source
	const dude: any = new PIXI.picture.Sprite(texture);
	// or create pixi sprite and set pluginName to 'picture'
